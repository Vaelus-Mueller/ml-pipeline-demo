...
def fill_missing_with_median(df: pd.DataFrame, columns):
...
def build_features(df: pd.DataFrame, feature_columns, target_column):
    """Prepare training features and target values."""
    df = fill_missing_with_median(df, feature_columns)
